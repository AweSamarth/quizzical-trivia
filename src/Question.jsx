...
//   console.log(temparr)
  ...
  const something = all_answers.map(ele=>{
    ...
    return {value:ele, isCorrect:ele==props.correct_answer?true:false, que:props.question}
  })
  ...
  const arraymapper = something.map((e) => {
    ...
    <div className="containers-container" key={e.value}>
      ...
      />
       ...
       <label id= {e.value} className="options" onClick={props.checker} value={e.value} htmlFor={e.value}>
         {e.value}
       </label>
     </div>
  )
  ...
  return (
    <div className="questiontop">
      <div className="main-question">
        <div className="onequestion">{props.question}</div>
